  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h1 className="text-xl font-bold text-gray-800">الأصناف</h1>
        {canEdit && (
          <div className="flex gap-2">
            <button className="btn-secondary" onClick={addCategory}>+ تصنيف</button>
            <button className="btn-primary" onClick={openNew}>+ صنف جديد</button>
          </div>
        )}
      </div>
