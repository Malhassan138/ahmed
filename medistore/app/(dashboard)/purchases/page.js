    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h1 className="text-xl font-bold text-gray-800 flex items-center gap-2">
          <Truck className="text-brand-600" size={22} /> المشتريات
        </h1>
        {canCreate && (
          <div className="flex gap-2">
            <button className="btn-secondary flex items-center gap-1" onClick={addSupplier}><Building2 size={16} /> مورد</button>
            <button className="btn-primary flex items-center gap-1" onClick={() => { setShowForm(true); setCart([{ productId: "", quantity: 1, costPrice: 0 }]); }}>
